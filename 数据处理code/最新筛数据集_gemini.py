...
# GEMINI_MODEL = "gemini-3-flash-preview" # 选择模型
...
#     # === 【关键修改】使用循环查找，不依赖 lines[0] 这种硬索引 ===
#     for line in lines:
#         # 1. 解析坐标
#         if "COORDINATES:" in line.upper(): 
#             try:
#                 # 使用正则提取数字，能处理 "(51.5, -0.1)" 或 "Lat: 51.5" 等各种情况
...
# def main():
#     # 你的 API KEY
#     client = genai.Client(api_key="AIzaSyBztCD3RTvr85a6dDA4t8lfSaDtvv2wZPc")
...
#     for item in tqdm(dataset, desc="Geo Evaluating..."):
...
# =========================
def main():
    client = genai.Client(api_key="AIzaSyCvqvwrAy3QSJ2ri-T6FzJq6wscfl4D834")
